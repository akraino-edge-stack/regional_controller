...
PORTAL_URL="https://nexus.akraino.org/service/local/artifact/maven/redirect?r=snapshots&g=org.akraino&a=portal_user_interface&v=$3&e=war"
TEMPEST_URL="https://nexus.akraino.org/service/local/artifact/maven/redirect?r=snapshots&g=org.akraino.test_automation&a=test_automation&v=1.0.0-SNAPSHOT&e=tgz"
YAML_BUILDS_URL="https://nexus.akraino.org/service/local/artifact/maven/redirect?r=snapshots&g=org.akraino.yaml_builds&a=yaml_builds&v=1.0.0-SNAPSHOT&e=tgz"
ONAP_URL="https://nexus.akraino.org/service/local/artifact/maven/redirect?r=snapshots&g=org.akraino.addon-onap&a=onap-amsterdam-regional-controller-master&v=1.0.0-SNAPSHOT&e=tgz"
SAMPLE_VNF_URL="https://nexus.akraino.org/service/local/artifact/maven/redirect?r=snapshots&g=org.akraino.sample_vnf&a=sample_vnf&v=1.0.0-SNAPSHOT&e=tgz"
AIRSHIPINABOTTLE_URL="https://nexus.akraino.org/service/local/artifact/maven/redirect?r=snapshots&g=org.akraino.airshipinabottle_deploy&a=airshipinabottle_deploy&v=1.0.0-SNAPSHOT&e=tgz"
REDFISH_URL="https://nexus.akraino.org/service/local/artifact/maven/redirect?r=snapshots&g=org.akraino.redfish&a=redfish&v=1.0.0-SNAPSHOT&e=tgz"
